...
class Agent_2:
    ...
    def __init__(self,agent_id,model_checkpoint_file,load,learning=None,db_type="mysql") -> None:
        self.pp = pprint.PrettyPrinter(indent=4)

        self.syntax_fixing_agent = Syntax_Fixing_Agent(learning,model_checkpoint_file,load=load)
