...
class Syntax_Fixing_Agent:
    def __init__(self,learning,model_checkpoint_file) -> None:
        ...
        self.action_Q_value = DQN(State_Representation.size()+5,1,q_value_file,q_value_file_mem,"syntax_fixing_action")
