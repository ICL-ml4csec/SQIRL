...
class Syntax_Fixing_Agent:
    def __init__(self,agent_id,domain,learning=True) -> None:
        ...
        server_port = 1234
        self.action_Q_value = DQNWorker(State_Representation.size() + 5, 1, f"syntax_fixing_action_{agent_id}", server_host, server_port, domain, learning)
        self.rdn = RDN(State_Representation.size()+5,1000,f"syntax_fixing_action_{agent_id}")
        self.epsilon = 0.6
