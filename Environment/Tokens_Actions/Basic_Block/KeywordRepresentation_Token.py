...
class KeywordRepresentation_Token(Token):
    ...
    def set_value(self,new_value):
        assert(KeywordRepresentation_Token.is_keyword(new_value))
        self.__keyword = new_value

    def type(self):
        return "Keyword Representation Token"

    def category(self):
        return Token.Category.BASIC_BLOCK

    def __str__(self) -> str:
        return str(self.__keyword)
    ...
    def is_all_caps(self):
        if self.__keyword.isupper() or self.__keyword.islower():
            ...
            return False
    def parse(s:str):
        assert(KeywordRepresentation_Token.is_keyword(s))
        return KeywordRepresentation_Token(s)
